...
import { useCreateWorkspaceModal, useCreateFirstWorkspaceModal } from "@/features/workspaces/store/stores";
import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';
import { useRouter } from 'next/navigation';
import { toast } from 'sonner';
  
const CreateFirstWorkspaceModal = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
        ...
        <DialogContent>
            <DialogHeader>
            <DialogTitle>Create a workspace to get started!</DialogTitle>
